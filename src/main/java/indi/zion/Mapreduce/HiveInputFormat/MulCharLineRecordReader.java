...
public class MulCharLineRecordReader extends RecordReader<LongWritable, Text> {
    ...
    public MulCharLineRecordReader() {
    }

    public MulCharLineRecordReader(byte[] recordDelimiter) {
