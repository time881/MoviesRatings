...
public class MulCharLineRecordReader implements RecordReader<LongWritable, Text> {
  ...
  public MulCharLineRecordReader(Configuration job, 
                          FileSplit split) throws IOException {
    this(job, split, null);
  }

  public MulCharLineRecordReader(Configuration job, FileSplit split,
      byte[] recordDelimiter) throws IOException {
  ...
  public MulCharLineRecordReader(InputStream in, long offset, long endOffset,
                          int maxLineLength) {
