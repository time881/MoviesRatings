...
public class MulCharLineRecordReader implements RecordReader<LongWritable, Text> {
    ...
    public void setUtil(DataCleanUtil util) {
        this.util = util;
    }

    public MulCharLineRecordReader(Configuration job, FileSplit split) throws IOException {
        this(job, split, null);
    }

    public MulCharLineRecordReader(Configuration job, FileSplit split, byte[] recordDelimiter) throws IOException {
    ...
    public MulCharLineRecordReader(InputStream in, long offset, long endOffset, int maxLineLength) {
    ...
    public MulCharLineRecordReader(InputStream in, long offset, long endOffset, Configuration job) throws IOException {
        this(in, offset, endOffset, job, null);
    }

    public MulCharLineRecordReader(InputStream in, long offset, long endOffset, Configuration job,
    ...
    public synchronized boolean next(LongWritable key, Text value) throws IOException {
        ...
        while (getFilePosition() <= end || in.needAdditionalRecordAfterSplit()) {
            ...
            if (util != null) {
                value.set(util.HiveLineFormat(value));
            } else {
                try {
                    throw new Exception("util must be init");
                } catch (Exception e) {
